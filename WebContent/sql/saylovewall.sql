...
delimiter ;;
CREATE PROCEDURE `attitude`(IN `in_name` varchar(50),IN `in_love_id` INT)
BEGIN
...
delimiter ;;
CREATE PROCEDURE `delete_discuss`(IN in_id INT)
BEGIN
...
delimiter ;;
CREATE PROCEDURE `find_love`(IN `sql_name` varchar(255),IN `in_love_id` int)
BEGIN
...
delimiter ;;
CREATE PROCEDURE `insert_discuss`(IN in_love_id int,IN in_user_id int,IN in_content VARCHAR(255)character set utf8)
BEGIN
...
delimiter ;;
CREATE PROCEDURE `raise_read`(IN `in_love_id` int)
BEGIN
...
delimiter ;;
CREATE PROCEDURE `suport`(IN `in_user_id` int,IN `in_love_id` int)
BEGIN
